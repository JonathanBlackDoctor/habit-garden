...
/**
 * 모델 라우팅.
 * - FAST: 짧은 생성·파싱·분류처럼 호출 빈도가 높은 기본 작업
 * - SMART: 주간 패턴 분석·장문 피드백처럼 추론 품질이 더 중요한 작업
 */
export const GEMINI_FAST_MODEL = 'gemini-3.1-flash-lite';
export const GEMINI_SMART_MODEL = 'gemini-3-flash';

/** 기존 호출부의 기본 모델. 새 코드에서는 FAST/SMART 중 의도를 명시하는 것을 권장한다. */
