...
export const WEEKLY_QUESTS: QuestDef[] = [
  {
    ...
    title: '아침 습관 5일 달성',
    goal: 5,
    reward: { points: 180, freezeTokens: 2 },
  ...
  },
  {
    ...
    title: '한 주 25회 달성',
    goal: 25,
    reward: { points: 220, freezeTokens: 1 },
  ...
  },
  {
    ...
    title: '0점 없는 한 주',
    goal: 7,
    reward: { points: 320, freezeTokens: 3 },
  ...
  },
  {
    ...
    title: '회고 5회 작성',
    goal: 5,
    reward: { points: 150, freezeTokens: 1 },
    progress: ({ dates, checks }) => {
  ...
  },
  {
    ...
    title: '완벽 점수(5점) 10회',
    goal: 10,
    reward: { points: 260, freezeTokens: 2 },
  ...
  },
  {
    ...
    title: '핵심 습관 15회 달성',
    goal: 15,
    reward: { points: 240, freezeTokens: 2 },
    // 가중치 8 이상(중요) 습관에 집중.
    progress: ({ dates, habits, checks }) => {
  ...
  },
  {
    ...
    goal: 5,
    reward: { points: 160, freezeTokens: 1 },
