import { Home, CheckSquare, HandHeart, MoreHorizontal } from 'lucide-react';
...
// 진척(통계·리포트)은 매일 보는 정보가 아니라 가끔 들여다보는 회고성 화면이라
// 하단 탭에서 빼고 '더보기'의 바로가기로 옮겼다. (스트릭은 오늘 탭 상단에 상존)
